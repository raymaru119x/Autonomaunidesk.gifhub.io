                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#" onclick="preguntarCuenta('Usuario')">Administrador</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="#" onclick="preguntarCuenta('Controlador')">Cliente</a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <div class="card-container">
                    <div class="card">
                        ...
                        <div class="content">
                            <p class="heading">1.</p>
                            <p>
                                Diseñar e implementar un sistema de registro y 
                                autenticación para la plataforma web, garantizando
                                la seguridad y accesibilidad de los usuarios.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card-container">
                    <div class="card">
                        ...
                        <div class="content">
                            <p class="heading">2.</p>
                            <p>
                                Diseñar y estructurar las tablas necesarias para
                                la base de datos, asegurando una organización 
                                eficiente y un manejo óptimo de la información.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card-container">
                    <div class="card">
                        ...
                        <div class="content">
                            <p class="heading">3.</p>
                            <p>
                                Desarrollar un software basado en Java que permita
                                la conexión remota entre dispositivos, facilitando 
                                una manipulación segura y controlada de los mismos.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card-container">
                    <div class="card">
                        ...
                        <div class="content">
                            <p class="heading">4.</p>
                            <p>
                                Crear un chatbot con inteligencia artificial para
                                brindar soporte a los usuarios sobre el uso del 
                                software, mejorando la experiencia de interacción
                                y asistencia.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-container">
                    <div class="card">
                        ...
                        <div class="content">
                            <p class="heading">5.</p>
                            <p>
                                Implementar una sección en la plataforma que 
                                permita la descarga del software de conexión remota
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            function preguntarCuenta(tipo) {
                Swal.fire({
                    title: "¿Ya tienes una cuenta?",
                    showDenyButton: true,
                    showCancelButton: false,
                    confirmButtonText: "Sí, tengo cuenta",
                    denyButtonText: "No, quiero registrarme",
                }).then((result) => {
